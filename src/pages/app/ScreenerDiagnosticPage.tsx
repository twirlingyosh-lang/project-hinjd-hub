...
import { ScreenerDiagnostics } from "@/data/screener_logic";
...
const ScreenerDiagnosticPage = () => {
  ...
  const goTo = (key: string) => {
    setHistory((h) => [...h, node]);
    setNode(ScreenerDiagnostics[key]);
  };
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground p-4 md:p-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-xl md:text-2xl font-bold">Screener Decision Tree</h1>
...
export default ScreenerDiagnosticPage;
